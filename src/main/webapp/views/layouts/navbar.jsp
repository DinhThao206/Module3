...
<div class="navbar">
    <!-- LOGO -->
    <div class="logo">
        <a href="${pageContext.request.contextPath}/home"> WEB TRUYỆN </a>
    </div>
    <!-- MENU -->
    <div class="menu">
        <a href="${pageContext.request.contextPath}/home"> Trang Chủ </a>

        <a href="${pageContext.request.contextPath}/genres"> Thể Loại </a>
    ...
    <div class="navbar-right">
        ...
        <div class="search-box">
            <form action="${pageContext.request.contextPath}/search" method="get">
                <input type="text" name="keyword" placeholder="Tìm truyện...">
                <button type="submit">
